...
import { IsString, IsEmail, IsOptional, IsEnum, IsBoolean, IsNumber, MinLength, MaxLength, Min } from 'class-validator';
...
export class CreateSupplierDto {
  ...
  @ApiProperty({ description: 'Supplier document (CNPJ/CPF)' })
  @IsString()
  @MinLength(11)
  @MaxLength(18)
  document: string;
  ...
  @ApiProperty({ enum: SupplierStatus, description: 'Supplier status', default: SupplierStatus.ACTIVE })
  @IsOptional()
  ...
  @ApiProperty({ description: 'Supplier website', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(200)
  website?: string;

  @ApiProperty({ description: 'Supplier description', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  description?: string;
  ...
  @ApiProperty({ description: 'Delivery time in days', required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  deliveryTime?: number;

  @ApiProperty({ description: 'Is preferred supplier', default: false })
  @IsOptional()
  @IsBoolean()
  isPreferred?: boolean;
